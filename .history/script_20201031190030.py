...
class Source:
    def __init__(self, source_url):
        ...
        self.articles = []
        self.get_article_urls_from_source()

    def get_article_urls_from_source(self, find_tag1, find_tag2, find_tag3, link1, link2 = None, link2 = None):
        ...
        for story in story[:15]:
            story_link = story.find(link1, {link2:link3})
